...
A total of 35 individuals completed 119 unique 'You Draw It' task plots. For each participant and parameter choice, the feedback data set contained $x, y_drawn, \hat y_{OLS}$, and $\hat y_{PCA}$.
