...
# logoright_name: '![](images\manuscript-qr-code.png){.main-img-right}'
...
A total of 35 individuals completed 119 unique 'You Draw It' task plots. For each participant, the final data set used for analysis contained $x, y_drawn, \hat y_{OLS}$, and $\hat y_{PCA}$ for each of the four parameter choices. 
