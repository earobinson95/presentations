...
.medium[*Modified from* [*Kiegan Rice.*](https://kiegan.github.io/talks/graphics-group-r2d3/graphics-group-r2d3.html#1)
]]]
???
...
```{r results='asis', echo = F, include = T, cache = F, eval = TRUE}
i1 <- img_modal(src = "images/eyefitting-trial-plot-2.png", alt = " ", other=list(width="80%"))
...
.center[
```{r results='asis', echo = F, include = T, cache = F, eval = TRUE}
i1 <- img_modal(src = "images/low-10-linear-2.png", alt = "Low Growth Rate, 50% Truncation, Linear Scale", other=list(width="30%"))
i2 <- img_modal(src = "images/low-10-log-2.png", alt = "Low Growth Rate, 50% Truncation, Log Scale", other=list(width="30%"))
...
```{r results='asis', echo = F, include = T, cache = F, eval = TRUE}
i1 <- img_modal(src = "images/low-15-linear-2.png", alt = "Low Growth Rate, 75% Truncation, Linear Scale", other=list(width="30%"))
i2 <- img_modal(src = "images/low-15-log-2.png", alt = "Low Growth Rate, 75% Truncation, Log Scale", other=list(width="30%"))
...
```{r results='asis', echo = F, include = T, cache = F, eval = TRUE}
i1 <- img_modal(src = "images/high-10-linear-2.png", alt = "High Growth Rate, 50% Truncation, Linear Scale", other=list(width="30%"))
i2 <- img_modal(src = "images/high-10-log-2.png", alt = "High Growth Rate, 50% Truncation, Log Scale", other=list(width="30%"))
...
```{r results='asis', echo = F, include = T, cache = F, eval = TRUE}
i1 <- img_modal(src = "images/high-15-linear-2.png", alt = "High Growth Rate, 75% Truncation, Linear Scale", other=list(width="30%"))
i2 <- img_modal(src = "images/high-15-log-2.png", alt = "High Growth Rate, 75% Truncation, Log Scale", other=list(width="30%"))
...
+ scale $k = 1,2$,
+ participant  $l = 1,...,N_\text{participant}$, and
+ $x_{ijklm}$ value $m = 1, ...,4 x_\text{max} + 1$. 
...
```{r results='asis', echo = F, include = T, cache = F, eval = TRUE}
i1 <- img_modal(src = "images/exponential-yloess-spaghetti-plot-2-1.png", alt = " ", other=list(width="100%"))
...
.center[
```{r results='asis', echo = F, include = T, cache = F, eval = TRUE}
i1 <- img_modal(src = "images/exponential-prediction-gamm-preds-2-2.png", alt = " ", other=list(width="64%"))
...
```{r results='asis', echo = F, include = T, cache = F, eval = TRUE}
i1 <- img_modal(src = "images/exponential-prediction-gamm-preds-2-3.png", alt = " ", other=list(width="64%"))
