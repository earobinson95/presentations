...
- Strayhorn (2012) developed a model for sense of belonging within higher education that is similar to Maslow’s hierarchy of needs. 
  - See his Tedx talk, "Inalienable Rights: Life, Liberty, and the Pursuit of Belonging: Terrell Strayhorn at TEDxColumbus" at https://www.youtube.com/watch?v=Ak6T9kw0H28 
...
1. Data plots corresponds to test statistics
...
8. Using a Binomial Distriution, expect to see the "guilty" plot selected 1/plots times by random chance.
...
- I have loved reading the visual inference papers and would like to find a way to do research around this area. It combines:
  - Experimental Design
  - Data Science
  - Communicating Statistics
  
- Concerns regarding the use of the P.O.W.E.R Survey in research:
...
- Possible directions:
  ...
  - Combine visual inference and student success data.
  - Detecting bias due to missing data
  - Impossible and Insane Idea (*see next slide*)
  - Other suggestions?
