...
#| fig-align: center
#| out-width: 100%
#| fig-subcap: "Image source: https://posit.cloud/"
...
::: callout-note
If you do not yet have a [posit Cloud](https://posit.cloud/) (previously known as Rstudio Cloud) account, you will have to sign up!
:::

+ *Illustrations used throughout this presentation by Allison Horst*
+ *Sketches used throughout this presentation by Susan VanderPlas*
...
#| out-width: 100%
#| fig-align: center
knitr::include_graphics("images/rvsrstudio.jpg")
```
...
+ Stat 331/531: Introduction to Statistical Computing
