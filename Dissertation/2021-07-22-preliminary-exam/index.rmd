...
```{r results='asis', echo = F, include = T, cache = F, eval = TRUE}
i1 <- img_modal(src = "images/log-scale-comic.png", alt = " ", other=list(width="100%"))
...
.center[
```{r results='asis', echo = F, include = T, cache = F, eval = TRUE}
i1 <- img_modal(src = "images/covid19-FT-03.23.2020-log.png", alt = " ", other=list(width="70%"))
...
```{r results='asis', echo = F, include = T, cache = F, eval = TRUE}
i2 <- img_modal(src = "images/covid19-FT-case-count-06.30.2020-linear.png", alt = " ", other=list(width="45%"))
i3 <- img_modal(src = "images/covid19-FT-case-count-06.30.2020-log.png", alt = " ", other=list(width="45%"))
...
Spence (1990) presents four example questions for comparing the sizes of individual graphical elements:
...
.center[
```{r results='asis', echo = F, include = T, cache = F, eval = TRUE}
i1 <- img_modal(src = "images/amer-poggendorff-illusion.png", alt = " ", other=list(width="80%"))
...
class:primary
# Phrasing of Estimation Questions
Dunn (1988), assessed the relative accuracy with which quantitative information is extracted from both types of charts. Participants were:
...
.center[
```{r results='asis', echo = F, include = T, cache = F, eval = TRUE}
i1 <- img_modal(src = "images/framed-murder-rate-map.png", alt = " ", other=list(width="60%"))
...
print(bib[[c("vanderplas_clusters_2017", "hofmann_graphical_2012", "loyVariationsQQPlots2016","buja_statistical_2009", "new_york_times_2017", "finney_subjective_1951", "mosteller_eye_1981", "burnmurdoch_2020", "lewandowsky_perception_1989")]], 
...
print(bib[[c("unwin_why_2020", "rost_2020", "romano_scale_2020", "best_perception_2007", "varshney_why_2013", "siegler_numerical_2017", "dehaeneLogLinearDistinct2008", "wagenaarMisperceptionExponentialGrowth1975")]], 
      .opts = list(check.entries = FALSE, style = "html", bib.style = "authoryear")
      )
```
</font>
...
+ An exception occurs when identifying a plot with more curvature than the surrounding plots, indicating that it is is more difficult to say something has less curvature, but easy to say that something has more curvature (Best, 2007). 
]
.pull-right[
```{r results='asis', echo = F, include = T, cache = F, eval = TRUE}
