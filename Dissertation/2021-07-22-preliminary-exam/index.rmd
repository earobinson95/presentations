...
.center[
```{r results='asis', echo = F, include = T, cache = F, eval = TRUE}
i1 <- img_modal(src = "images/covid19-FT-case-count-06.30.2020-linear.png", alt = Citep(bib[[c("burnmurdoch_2020")]]), other=list(width="80%"))
...
```{r results='asis', echo = F, include = T, cache = F, eval = TRUE}
i1 <- img_modal(src = "images/covid19-FT-case-count-06.30.2020-log.PNG", alt = Citep(bib[[c("burnmurdoch_2020")]]), other=list(width="80%"))
