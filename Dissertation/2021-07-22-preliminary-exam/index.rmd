...
+ The usefulness of the log scale in science is illustrated showing the challenge of displaying the fuel energy density of Uranium along side other sources of fuel due to differences in magnitude of density.
...
Our perception and mapping of numbers to a number line is **logarithmic at first**, but transitions to a **linear scale later** in development, with formal mathematics education `r Citep(bib[[c("dehaene2008log", "siegler_numerical_2017", "varshney_why_2013")]])`.
