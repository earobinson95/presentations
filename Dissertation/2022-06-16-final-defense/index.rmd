...
Previous results have found few differences between expert and non-expert participants in this context `r Citep(bib[[c("vanderplas2015spatial")]])`. 

.center[
```{r results='asis', echo = F, include = T, cache = T, eval = TRUE}
i1 <- img_modal(src = "images/age-demplot.png", other=list(width="45%"))
i2 <- img_modal(src = "images/gender-demplot.png", other=list(width="45%"))
...
```{r results='asis', echo = F, include = T, cache = T, eval = TRUE}
i1 <- img_modal(src = "images/education-demplot.png", other=list(width="45%"))
i2 <- img_modal(src = "images/mouse-demplot.png", other=list(width="45%"))
